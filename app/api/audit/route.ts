      ...
      : {
          ...
          quickWins:
            deterministicQuickWins.length > 0
              ...
              : [
                  "Apply the top recommendation highlighted in this report",
                  "Fix the highest-priority conversion blocker first",
                  "Run a second scan after changes to confirm impact",
                ],
