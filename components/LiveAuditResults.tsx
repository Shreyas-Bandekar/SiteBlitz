              ...
              {report.competitors?.length ? (
                ...
                <div className="space-y-3 rounded-xl border border-border bg-secondary/20 p-4">
                  <p className="text-sm text-foreground/80">
                    {report.competitorBenchmarkStatus?.message ||
                      "We could not find enough real competitor data for this scan yet."}
                  </p>
                  <p className="text-xs text-muted-foreground">
                    Why this matters: competitor benchmarks help you see whether your score is strong for your market, not just in isolation.
                  </p>
                  <div className="rounded-lg bg-background/60 p-3 text-xs text-foreground/80">
                    <p className="font-semibold">What to do next</p>
                    <p>1. Audit 2 to 3 direct competitor URLs from your niche.</p>
                    <p>2. Re-run your website scan.</p>
                    <p>3. You will then get a side-by-side benchmark view automatically.</p>
                  </div>
                </div>
              )}
            </CardContent>
